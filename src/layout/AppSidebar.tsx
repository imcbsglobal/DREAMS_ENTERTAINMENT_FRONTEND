...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "List Staff", path: "/list-staff", pro: false },
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Reports",
    subItems: [
      { name: "Ticket & Revenue", path: "/ticket-revenue-report", pro: false },
      { name: "Staff Report", path: "/staff-report", pro: false },
    ],
  },
];

const advanceControlItems: NavItem[] = [
  {
    icon: <PlugInIcon />,
    name: "Advance Control",
    subItems: [
      { name: "Delete Tickets", path: "/delete-tickets", pro: false },
    ],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "others", "advance"].forEach((menuType) => {
      const items = menuType === "main" ? navItems : menuType === "others" ? othersItems : advanceControlItems;
      items.forEach((nav, index) => {
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({
                type: menuType as "main" | "others" | "advance",
                index,
              });
              submenuMatched = true;
            }
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "others" | "advance") => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "others" | "advance") => (
        ...
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            nav.path && (
              <Link
                to={nav.path}
                className={`menu-item group justify-start ${
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="">
              ...
              {renderMenuItems(advanceControlItems, "advance")}
            </div>
          </div>
        </nav>
